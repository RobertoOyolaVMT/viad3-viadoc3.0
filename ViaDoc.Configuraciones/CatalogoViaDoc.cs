...
namespace ViaDoc.Configuraciones
{
    public class CatalogoViaDoc
    {
        ...
        public static string LeyendaRegimenRimpe => ConfigurationManager.AppSettings["PROCESO.REGIMEN.RIMPE"];
        public static string LeyendaGeneral => ConfigurationManager.AppSettings["PROCESO.REGIMEN.GENERAL"]; 
        ...
        public static string ParametrosValorIVA15 => ConfigurationManager.AppSettings["NOTIFICACION.15%"];
        public static string ParametrosValorIVA5 => ConfigurationManager.AppSettings["NOTIFICACION.5%"];
